...
#
# REGIONAL ANNUAL MEAN MHW CUMULATIVE INTENSITY
...
#
# Daily climatology and P90:
#   +/-5-day climatological window
#   31-day circular smoothing
#
# MHW daily intensity:
#   SST - daily climatological mean
#
# MHW cumulative intensity:
#   Sum of daily intensity over one confirmed MHW event
#
# PANEL (e):
#   Regional annual mean MHW cumulative intensity
#   Units = °C Days
#
# PANEL (f):
#   Annual Mean SST vs MHW Cumulative Intensity
#   Units = °C Days
#
# Black line:
...
#
# IMPORTANT:
#   A grid cell/year with no MHW event has NaN cumulative
#   intensity, NOT zero.
# ==============================================================
...
#
# Map all calendar dates onto leap year 2000.
# ==============================================================
...
# ==============================================================
# 5. CALCULATE ANNUAL MEAN MHW CUMULATIVE INTENSITY
#
# STEP:
#
# 1. Detect continuous SST > P90 runs.
# 2. Keep runs lasting >=5 days.
# 3. Calculate daily intensity:
#
#       SST - climatological mean
#
# 4. Sum intensity across each event.
#
#       cumulative intensity = sum(daily intensity)
#
# 5. Average cumulative intensity of all events in each year.
#
#
# Example:
#
...
def calculate_annual_mean_cumulative_intensity(
    ...
    # ----------------------------------------------------------
    # Sum of event cumulative intensities per year
    # ----------------------------------------------------------
                ...
                if run_finished:
                    ...
                    if duration >= MIN_DURATION:
                        ...
                        if (
                            ...
                            event_intensity = intensity_series[
                                start:end + 1
                            ]


                            # ----------------------------------
                            # Only use complete valid event
                            # ----------------------------------
    ...
    return annual_mean_cumulative.reshape(
        len(years),
        n_lat,
        n_lon
    )
...
print(
    "REGIONAL MHW CUMULATIVE INTENSITY "
    "AND SST ANALYSIS"
)
...
# 11. ANALYSIS PERIOD
#
# Keep available 1981 internally to ensure events crossing
# Dec 1981-Jan 1982 are detected continuously.
# ==============================================================
...
for block_number, block_start in enumerate(
    ...
    # ==========================================================
    # 13B. DAILY CLIMATOLOGY + DAILY P90
    # ==============================================================
    ...
    # ==========================================================
    # 13C. SMOOTH CLIMATOLOGY AND P90
    # ==============================================================
    ...
    # ==========================================================
    # 13E. MATCH DAILY CLIMATOLOGY/P90 TO DATES
    # ==============================================================
    ...
    # ==========================================================
    # 13I. ANNUAL MEAN CUMULATIVE INTENSITY
    # ==============================================================

    print(
        "Detecting MHW events and calculating "
...
# 15. AREA WEIGHTS
#
# OISST uses regular lat/lon cells.
#
# Relative grid-cell area is proportional to cos(latitude).
# ==============================================================
...
# ==============================================================
# 16. REGIONAL ANNUAL MEAN MHW CUMULATIVE INTENSITY
#
# Area-weighted average of the annual mean cumulative
# intensity at all valid ocean grid cells.
#
# Units:
#   °C Days
# ==============================================================
...
print(
    "\nCalculating regional annual mean "
    "MHW cumulative intensity..."
)


regional_annual_cumulative = np.full(
...
#
# 1. Annual mean SST at each grid cell
# 2. Area-weighted regional average
#
# Units:
#   °C
# ==============================================================
...
# ==============================================================
# 18. SST-CUMULATIVE INTENSITY REGRESSION
#
# X =
#   Regional annual mean SST
#
# Y =
#   Regional annual mean MHW cumulative intensity
# ==============================================================
...
print(
    "REGIONAL ANNUAL MHW CUMULATIVE INTENSITY"
)
...
for year, cumulative, temp in zip(
...
print(
    "SST–MHW CUMULATIVE INTENSITY REGRESSION"
)
...
# 22. PANEL E
#
# ANNUAL REGIONAL MHW CUMULATIVE INTENSITY
# ==============================================================
...
ax.set_ylabel(
    ...
    "MHW Cumulative Intensity [°C Days]",
...
# 23. PANEL F
#
# ANNUAL SST vs MHW CUMULATIVE INTENSITY
# ==============================================================
...
# 24. R² ANNOTATION
#
# Bottom-right like your sample figure.
# ==============================================================
...
# ==============================================================
# 26. MAIN FIGURE TITLE
# ==============================================================

fig.suptitle(

    "Regional Annual Marine Heatwave Cumulative Intensity "
...
print(
    "\nRegional MHW cumulative intensity–SST "
